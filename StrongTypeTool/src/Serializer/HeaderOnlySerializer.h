...
public:
    explicit HeaderOnlySerializer(TemplateManager templateManager)
...
private:
    ...
    serializeBinaryOperation(const stt::BinaryOperation& binaryOperation);
    std::pair<std::string, std::string>
    serializeUnaryOperation(const stt::UnaryOperation& unaryOperation);
