...
namespace stt {
    ...
    public:
        ...
        StrongType(std::string typeName, std::string wraps,
                   std::vector<stt::BinaryOperation> binOps, std::vector<stt::UnaryOperation> unOps)
            : typeName(std::move(typeName)), wraps(std::move(wraps)),
              binaryOperations(std::move(binOps)), unaryOperations(std::move(unOps)) {}
