...
stt::StrongType::Builder*
stt::StrongType::Builder::setBinOps(std::vector<stt::BinaryOperation> binaryOperations) {
    this->binaryOperations = std::move(binaryOperations);
    return this;
}

stt::StrongType::Builder*
stt::StrongType::Builder::setUniOps(std::vector<stt::UnaryOperation> unaryOperations) {
    this->unaryOperations = std::move(unaryOperations);
    return this;
}

const std::string& stt::StrongType::getTypeName() const { return this->typeName; }

const std::string& stt::StrongType::getWraps() const { return this->wraps; }
